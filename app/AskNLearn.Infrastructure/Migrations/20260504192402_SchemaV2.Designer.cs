...
namespace AskNLearn.Infrastructure.Migrations
{
    ...
    [Migration("20260504192402_SchemaV2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AskNLearn.Domain.Entities.Core.Report", b =>
                {
                    ...
                    b.ToTable("Reports", t =>
                        {
                            t.HasCheckConstraint("CK_Reports_Target", "(ReportedPostId IS NOT NULL AND ReportedCommentId IS NULL) OR (ReportedPostId IS NULL AND ReportedCommentId IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("AskNLearn.Domain.Entities.Core.Resource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AskNLearn.Domain.Entities.SocialFeed.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AskNLearn.Domain.Entities.SocialFeed.CommentAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AskNLearn.Domain.Entities.SocialFeed.CommentReaction", b =>
                {
                    b.Property<Guid>("CommentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("CommentId", "UserId", "EmojiCode");
            ...
            modelBuilder.Entity("AskNLearn.Domain.Entities.Core.Report", b =>
                {
                    b.HasOne("AskNLearn.Domain.Entities.SocialFeed.Comment", "ReportedComment")
                        .WithMany()
            ...
            modelBuilder.Entity("AskNLearn.Domain.Entities.SocialFeed.Comment", b =>
                {
                    ...
                    b.HasOne("AskNLearn.Domain.Entities.SocialFeed.Comment", "ReplyToComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("AskNLearn.Domain.Entities.SocialFeed.CommentAttachment", b =>
                {
                    b.HasOne("AskNLearn.Domain.Entities.SocialFeed.Comment", "Comment")
                        .WithMany("Attachments")
